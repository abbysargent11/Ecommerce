...
<?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Red Calcite2'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/redcalcite2.jpg".$row['image']."'>";
...
<div id="description">
    ...
    <h1>Golden Hand-Wrapped Raw Red Calcite</h1>
    <p>Known for cleansing and amplified the energy of an environment. Can provide the wearer with motivation and growth development. Can also help to transmute energies and reurn them tenfold.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Red Calcite2">
