...
<?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Moonstone'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/moonstone.jpg".$row['image']."'>";
...
<div id="description">
    ...
    <h1>Golden Hand-Wrapped Tumbled Moonstone</h1>
    <p>Perfect for inner growth and strength. She soothes emotions and stress, providing calm energy. Great for protection and connection with the moon.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Moonstone">
