...
<?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Obsidian'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/black.jpg".$row['image']."'>";
...
<div id="description">
    <h1>Golden Hand-Wrapped Tumbled Black Tourmaline</h1>
    <p>Provides the wearer with protection from negative emotions and negative energies. Can provide grounding energies and help release constant worrying.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Obsidian">
