...
$conn = new mysqli($servername, $username, $password, $dbname);
            ...
            $sql = "SELECT photo FROM products WHERE name='Moss Agate'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/mossagate.jpg".$row['image']."'>";
...
<div id="description">
    ...
    <h1>Golden Hand-Wrapped Tumbled Moss Agate</h1>
    <p>Known to attact wealth, abundance, and success. A stone of new beginnings, new business, and growth of existing businesses. Also known as the gardeners stone, she's great for plant health and connecting to nature.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Moss Agate">
