...
<?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Aventurine'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/aventurine.jpg".$row['image']."'>";
...
<div id="description">
    ...
    <h1>Golden Hand-Wrapped Tumbled Green Aventurine</h1>
    <p>Known as the opportunity stone and considered one of the luckiest. Can help the wearer boost feelings of gratitude and optimism. Also inspires a connection to nature and promotes harmony.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Aventurine">
