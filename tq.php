...
<?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Turquoise'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/turquoise.jpg".$row['image']."'>";
...
<div id="description">
    ...
    <h1>Golden Hand-Wrapped Tumbled Turquoise</h1>
    <p>Known to bring luck, peace, and protection. Can help to move energies and not feel stuck in a stagnant place.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Turquoise">
