...
<?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Yellow Calcite'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/yellowcalcite.jpg".$row['image']."'>";
...
<div id="description">
    ...
    <h1>Golden Hand-Wrapped Raw Yellow Calcite</h1>
    <p>Can provide help with learning, as well as teaching. Great stone of meditation and calming the mind.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Yellow Calcite">
