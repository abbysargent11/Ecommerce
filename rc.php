...
<?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Citrine2'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/citrine2.jpg".$row['image']."'>";
...
<div id="description">
    ...
    <h1>Golden Hand-Wrapped Raw Citrine</h1>
    ...
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Citrine2">
