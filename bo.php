...
<?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Obsidian2'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/obsidian.jpg".$row['image']."'>";
...
<div id="description">
    ...
    <h1>Golden Hand-Wrapped Tumbled Black Obsidian</h1>
    <p>Known for psychic protection, shielding from negative energies, and removing negativity. Can help with transformation and manifestion as well.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Obsidian2">
