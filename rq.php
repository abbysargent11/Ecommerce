...
<?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Rose Quartz'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/rosequartz.jpg".$row['image']."'>";
...
<div id="description">
    ...
    <h1>Golden Hand-Wrapped Raw Rose Quartz</h1>
    <p>Known for it's unconditional love. It's amazing for self-love, friendship, partnership, and attraction. It's also great for emotional healing and feeling harmony.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Rose Quartz">
    ...
    <footer>
        <p class="footerParagraph"><u>Useful Links</u></p>
        <ul>
