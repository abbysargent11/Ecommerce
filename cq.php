...
<?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Clear Quartz'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/clearquartz.jpg".$row['image']."'>";
...
<div id="description">
    ...
    <h1>Golden Hand-Wrapped Clear Quartz</h1>
    <p>Such a powerful and universal stone. Can be used for whatever intention that you set, which makes her perfect for beginners.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Clear Quartz">
