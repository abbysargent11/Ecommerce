  ...
  background-image: url('../Photos/background.png');
    ...
    <header>
        ...
        <?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Amethyst'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/amethyst.jpg".$row['image']."'>";
...
<div id="description">
    <h1>Golden Hand-Wrapped Tumbled Amethyst</h1>
    <p>Known as the healing stone. This pendant can provide calming and protective energy. Great for those who are new to crystals and want something gentle but helpful.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Amethyst">
