...
<?php
            ...
            $sql = "SELECT photo FROM products WHERE name='Tigers Eye'";
            $result = $conn->query($sql);

            echo "<img src='../Photos/greentigerseye.jpg".$row['image']."'>";
...
<div id="description">
    ...
    <h1>Golden Hand-Wrapped Tumbled Tigers Eye</h1>
    <p>Can give the wearer courage to keep moving forward, especially in times of deep healing or self-improvement. Tigers eye can also help protect against negative energies and can help push yourself outside of your comfort zone.</p>
    <p class="price">$25</p>
    <button onclick="myFunction()" class="button">Purchase</button>
    <form id="form" method="post" action="../addpurchase.php">
        <input class="boxes" type="text" name="name" value="Tigers Eye">
